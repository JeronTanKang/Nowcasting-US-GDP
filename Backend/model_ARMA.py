...
def arma_nowcast(file_path: str, target_variable: str = "GDP"):
    """
    This function reads in macroeconomic data, trains an ARMA model, and returns the GDP nowcast for the next time step.
    ...
    # nowcast GDP for the next available quarter
